...
\author{Daniela Huppenkothen\altaffilmark{1, 2, 3}, Lucy M. Heil\altaffilmark{4}, David W. Hogg\altaffilmark{1,2}, Andreas Mueller\altaffilmark{1}}
...
%For most problems in X-ray astronomy, there is not enough data available to make using these methods feasible. Algorithms that work on relatively small data sets exist, but they generally work better with data with fewer dimensions. 
...
\end{equation}
% AM is there no bias term? CHECK THIS
% AM did you do this yourself or use sklearn ridge regression? CHECK THIS
