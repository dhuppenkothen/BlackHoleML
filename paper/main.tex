...
Using the results of the previous sections and the parameters determined in Section \ref{sec:freeparams}, we performed supervised classification using logistic regression on the combined training and validation set for GRS 1915+105 \footnote{The full set of observations with probabilities for each state as well as all code relevant to the project can be found at the following address: \url{https://github.com/dhuppenkothen/BlackHoleML}}.
