...
% Why do you use the reduced feature set? Does that provide better generalization performance? Looking at figure 3 is testing many hypotheses, so you might be overfitting by picking 11 (also, isn't 13 higher?). [FIXED]
...
% AM not sure I understand the sentence FIXED?
...
% AM don't start a sentence with a number FIXED
...
% AM "this might argue" is not correct, I think. maybe "this is indicative of"? FIXED
% AM classes previously observed -> previously observed classes FIXED
% AM "on what has been seen before" maybe avoid passive "on what it has been trained on"? FIXED
...
% AM I found this sentence hard to parse. maybe "compared to at most 3 states in other.." (otherwise it sounds like this RHXRB was compared to 3 others) FIXED
...
% AM dataset of unprecedented scale? FIXED
...
% AM "we"->"it" or "we" -> "a fourier representation"? FIXED
...
% AM it's unclear what the "alone" means. Maybe "which achieve 90% by themselves? Without using any other features"? FIXED
